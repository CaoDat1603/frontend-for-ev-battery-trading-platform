...
export const ElectricCarBatteryPage: React.FC<EcycleCategoryPageProps> = ({ globalSearchTerm }) => {
        ...
        <Box sx={{ flexGrow: 1, pb: 4, bgcolor: '#f5f5f5' }}>
            ...
            <Container maxWidth="lg" sx={{ pt: 3 }}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                    ...
                    <Link to="/car-ecycle" style={{ textDecoration: 'text.primary', color: 'black', fontWeight: 'bold', }}>
                        <DirectionsCarIcon sx={{ fontSize: 16, verticalAlign: 'middle', mr: 0.5 }} /> Ô tô điện
                    </Link>
                </Typography>
